...
let initialState = {
	...
	login: null,
	isAuth: false,
	captchaUrl: null, // если null, то капча не требуется
};
...
export const login = (email, password, rememberMe, captcha) => async (dispatch) => {
	...
	if (response.data.resultCode === 0) {
		...
		if (response.data.resultCode === 10) {//Если с сервера пришла ошибка 10(много раз входили),тогда мы запросим Captcha
